    ...
    >
      <Container size="lg">
        <Grid gutter="xl">
          ...
          <Grid.Col span={{ base: 12, sm: 6, md: 4 }}>
            <Stack gap={4}>
              ...
              <Text size="sm">sales@celestestone.com.au</Text>
              <Text size="sm">1300 SLABZ 4 U</Text>
        ...
        <Group justify="space-between">
          <Text size="xs">
            © {new Date().getFullYear()} Celeste Stone Pty Ltd
          </Text>
          <Text size="xs">Built by the ladz at the slab yard</Text>
        </Group>
      </Container>
    </Box>
  );
